...
export const AI_HYBRID_ENGINES: EngineDefinition[] = [
  ...
  },
  {
    id: 'a2a_depth',
    name: 'A2A Depth',
    description: 'Agent-to-agent delegation depth limits',
    category: 'ai_hybrid',
    tier: 'enforce',
    browserAvailable: false,
  },
  {
    id: 'tool_parameter_validator',
    name: 'Tool Parameter Validator',
    description: 'Tool call parameter validation',
    category: 'ai_hybrid',
    tier: 'enforce',
    browserAvailable: false,
  },
  {
    id: 'reasoning_quality_monitor',
    name: 'Reasoning Quality Monitor',
    description: 'Reasoning chain quality checks',
    category: 'ai_hybrid',
    tier: 'enforce',
    browserAvailable: false,
  },
